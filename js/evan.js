...
//CUSTOMIZABLES
	if (typeof SUBREDDITS === 'undefined') { SUBREDDITS = ["earthporn","villageporn"]; }
	if (typeof ALBUMS === 'undefined') { ALBUMS = []; }
	if (typeof yt_players === 'undefined') { yt_players = ['y6120QOlsfU']; }
	if (typeof discoScale === 'undefined') { discoScale = true; }
	if (typeof discoLights === 'undefined') { discoLights = true; }
